...
function PlayAnnounce() {
  return (
    <div className="fixed bottom-0 left-0 right-0 pb-5 flex justify-center">
      <div className="flex justify-center items-center p-3 font-semibold text-white text-center bg-gray-900 ring-1 ring-inset ring-gray-900 rounded-full space-x-1.5">
